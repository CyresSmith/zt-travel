                ...
                >
                    <div className="relative flex w-full flex-wrap gap-1">
                        {selected.map(option => {
                            return (
                                <Badge
                                    key={option.value}
                                    className={cn(
                                        'rounded-full bg-themeYellow text-themeFg',
                                        'data-[disabled]:opacity-50',
                                        'data-[fixed]:bg-themeBg data-[fixed]:text-themeFg data-[fixed]:hover:bg-themeBg/90',
                                        badgeClassName
                                    )}
                        ...
                        <CommandPrimitive.Input
                            ...
                            className={cn(
                                'flex-1 bg-transparent outline-none placeholder:text-themeFg/80',
                                {
                        ...
                        <button
                            ...
                            className={cn(
                                'flex h-6 w-6 items-center justify-center fill-themeRed/50 p-0 hover:fill-themeRed',
                                THEME_TRANSITION,
                                (hideClearAllButton ||
                                    disabled ||
                                    selected.length < 1 ||
